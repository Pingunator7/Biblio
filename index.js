...
app.get("/libros", (req, res) => {
  ...
  connection.query(sql, (err, results) => {
    if (err) {
      console.error("Error en GET /libros:", err);
...
app.get("/autores", (req, res) => {
  connection.query("SELECT id, nombre FROM autores ORDER BY nombre ASC", (err, results) => {
    if (err) {
      console.error("Error en GET /autores:", err);
...
app.post("/libros", (req, res) => {
  ...
  connection.query(
    ...
    (err, result) => {
      if (err) {
        console.error("Error en POST /libros:", err);
...
app.put("/libros/:id", (req, res) => {
  ...
  connection.query(
    ...
    (err, result) => {
      if (err) {
        console.error("Error en PUT /libros/:id:", err);
...
app.delete("/libros/:id", (req, res) => {
  ...
  connection.query("DELETE FROM libros WHERE id = ?", [id], (err, result) => {
    if (err) {
      console.error("Error en DELETE /libros/:id:", err);
